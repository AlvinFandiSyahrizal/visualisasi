...
<body>
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('line1.store') }}" method="POST" id="createForm">
                            @csrf
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="LINE" class="form-control" value="line1" readonly>
                                        </td>
                                        <td>
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        ...
                        <table id="dataInputTable" class="table table-bordered">
                            ...
                            <tbody>
                                @forelse($dbflange1s as $dbflange)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                action="{{ route('line1.destroy', $dbflange->id) }}" method="POST"
        ...
        @foreach ($dbflange1s as $dbflange)
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="editForm-{{ $dbflange->id }}" method="POST"
                                action="{{ route('line1.update', ['line1' => $dbflange->id]) }}">
                                @csrf
                                @method('PUT')
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="editLine-{{ $dbflange->id }}" name="LINE" class="form-control" value="line1" readonly>
                                </div>
                                <div>
